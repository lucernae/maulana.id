...
![VSCode and VNC Debug Session side by side](/static/content/assets/uploads/screenshot_20200813_031044.png "VSCode and VNC Debug Session side by side")
...
![PyCharm Python Debug Server](/static/content/assets/uploads/screenshot_20200813_032047.png "PyCharm Python Debug Server")

In nut shell, I want to start a debug server. However contrary with how gdbserver works, the debug server will be running in my host, by PyCharm. This is why I put my ethernet interface IP address in the IDE hostname field. You can't use `localhost` because from the process inside the containers, localhost is the container itself, so you won't connect. You have to put where your host is, which is the interface address from the container perspectives. If you are still confused, perceive the container as a separate computer somewher that is connected with your LAN or WiFi. In that case, obviously you need to put your real host IP Adress for the container to be able to reach you.
...
![PyCharm Debug Console](/static/content/assets/uploads/screenshot_20200813_032705.png "PyCharm Debug Console")
...
![Attaching the debug client](/static/content/assets/uploads/screenshot_20200813_033026.png "Attaching the debug client")
...
As QGIS uses Qt framework, I was forced to watch Qt variables. One of the annoying things for me is I wouldn't be able to see QString text in VSCode debuggers because it can't read the data structure.
...
![Print Qt String as text](/static/content/assets/uploads/screenshot_20200813_044206.png "Print Qt String as text")
