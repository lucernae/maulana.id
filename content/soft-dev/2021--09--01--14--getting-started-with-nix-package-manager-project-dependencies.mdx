...
[Niv](https://hackage.haskell.org/package/niv) is a tool used to pin Nix-based dependencies. If we are to make comparison, it is analoguous with why yarn.lock, Python's REQUIREMENTS.txt, 
