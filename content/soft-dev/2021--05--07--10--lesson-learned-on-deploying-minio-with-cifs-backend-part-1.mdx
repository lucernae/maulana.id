...
We're going to revise the architecture a bit in the next part of the articles: [Part 2](2021--05--07--10--lesson-learned-on-deploying-minio-with-cifs-backend-part-2)