...
The barycenter is going to be used as the *center* (pun intended) of our derivation. If we want to use Newton's Second Law. There has to be an inertial reference frame where Newton's First Law holds true.
