...
So all is good right? Well it does run, but now the generic object does not have `Print()` function.
...
- Final, runnable go codes can be seen in [github](https://github.com/lucernae/maulana.id/site/src/content/soft-dev/2025--07--10--00--go-generic-object-receiver/main.go)
